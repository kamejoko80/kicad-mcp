...
def build_workbook(
    ...
    if unavailable:
        ws.cell(row=current_row, column=5, value="Total (Not on Mouser)").font = Font(bold=True)
    ...
    non_mouser_total_ref = f"I{non_mouser_total_row}" if non_mouser_total_row else "0"
